...
import {
  BadgeCheck, Building2, ChevronRight, Download, FileText, LandPlot, MapPin,
  MessageCircle, Ruler, ShieldCheck, Sparkles, Users, CalendarClock,
} from 'lucide-react';
...
export function PropertyDetail({ property, related }: { property: Property; related: Property[] }) {
